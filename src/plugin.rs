...
use crate::aoc_2024::day_23;
use crate::aoc_2024::day_24;
use crate::aoc_2024::day_25;
...
impl PluginManager {
    pub fn new() -> Self {
        ...
        map.insert((23 as u8, 2024 as u16), Box::new(day_23::AoC2024Day23));
        map.insert((24 as u8, 2024 as u16), Box::new(day_24::AoC2024Day24));
        map.insert((25 as u8, 2024 as u16), Box::new(day_25::AoC2024Day25));
